                        ...
                        <tbody>
                            <c:forEach items="${history}" var="list">
                                <tr>
                                    ...
                                    <td>${list.fromAddr}</td>
                                    <td>${list.toAddr}</td>
                                    <td><a href="/customer/edit?action=editTaxiOrder&taxiOrderId=${list.getId()}">edit</a></td>
                                    <td><a href="/customer/edit?action=deleteTaxiOrder&taxiOrderId=${list.getId()}">X</a></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
