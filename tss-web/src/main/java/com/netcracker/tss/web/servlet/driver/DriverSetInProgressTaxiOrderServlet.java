 ...
 */
@WebServlet(urlPatterns = "/driver/inprogress")
public class DriverSetInProgressTaxiOrderServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (taxiOrderBeanLocal.setInProgressTaxiOrder(taxiOrderId, driver)) {
            request.setAttribute("taxiOrderId", taxiOrderId);
            request.setAttribute("pageContent", "content/confirmation-inprogress.jsp");
            request.getRequestDispatcher(
                    "/WEB-INF/views/driver/driver-template.jsp").forward(
                            request, response);
        } else {
            request.setAttribute("taxiOrderId", taxiOrderId);
            request.setAttribute("pageContent", "content/another-driver.jsp");
            request.getRequestDispatcher(
                    "/WEB-INF/views/driver/driver-template.jsp").forward(
                            request, response);
        }
