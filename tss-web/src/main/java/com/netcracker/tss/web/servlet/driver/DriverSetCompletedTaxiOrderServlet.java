 ...
 */
@WebServlet(urlPatterns = "/driver/completed")
public class DriverSetCompletedTaxiOrderServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (taxiOrderBeanLocal.setCompletedTaxiOrder(taxiOrderId, driver)) {
            request.setAttribute("taxiOrderId", taxiOrderId);
