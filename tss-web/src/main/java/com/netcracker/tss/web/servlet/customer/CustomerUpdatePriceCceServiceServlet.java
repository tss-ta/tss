 ...
 * @author Lis
 */
@WebServlet(name = "ccePriceServlet",
        urlPatterns = "/priceCceService")
public class CustomerUpdatePriceCceServiceServlet extends HttpServlet {
     ...
     */
    public CustomerUpdatePriceCceServiceServlet() {
        super();
    ...
    private float calculateDistance(HttpServletRequest request) {
        float distance = 0;
         ...
         String[] fromListAddr = request.getParameterValues("fromList[]");
